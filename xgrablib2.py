...
<CRAB HUIDIG_TIJDSTIP="%s" xmlns="http://crab.agiv.be"><COMPONENTEN>
    ...
    def STRAATNAMEN(self):
        with self.con as con:
            cur = con.cursor()
            STRAATNAMENnode = '<STRAATNAMEN objecttype="straatnaam">'
            self.xgrabFile.write( STRAATNAMENnode )
    ...
    def STRAATNAAMSTATUSSEN(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring(STRAATNAAMSTATUSSENnode))
    ...
    def HUISNUMMERS(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( HUISNUMMERSnode))
    ...
    def HUISNUMMERSTATUSSEN(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( HUISNUMMERSTATUSSENnode))
    ...
    def SUBADRESSEN(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( SUBADRESSENnode))
    ...
    def POSTKANTONCODES(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( POSTKANTONCODESnode))
    ...
    def RRSTRAATNAAM_STRAATNAAM_RELATIES(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( RRSTRAATNAAM_STRAATNAAM_RELATIESnode))
    ...
    def STRAATKANTEN(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( STRAATKANTENnode))
    ...
    def WEGOBJECTEN(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( WEGOBJECTENnode))
    ...
    def WEGVERBINDINGSTATUSSEN(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( WEGVERBINDINGSTATUSSENnode))
    ...
    def WEGVERBINDINGGEOMETRIEN(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( WEGVERBINDINGGEOMETRIENnode))
    ...
    def TERREINOBJECT_HUISNUMMER_RELATIES(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( TERREINOBJECT_HUISNUMMER_RELATIESnode))
    ...
    def TERREINOBJECTEN(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( TERREINOBJECTENnode ))
    ...
    def GEBOUWSTATUSSEN(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( GEBOUWSTATUSSENnode ))
    ...
    def GEBOUWGEOMETRIEN(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( GEBOUWGEOMETRIENnode ))
    ...
    def RRADRESSEN(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( RRADRESSENnode ))
    ...
    def ADRES_RRADRES_RELATIES(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( ADRES_RRADRES_RELATIESnode ))
    ...
    def KADADRESSEN(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( KADADRESSENnode ))
    ...
    def ADRES_KADADRES_RELATIES(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( ADRES_KADADRES_RELATIESnode ))
    ...
    def ADRESPOSITIES(self):
        with self.con as con:
            ...
            self.xgrabFile.write( etree.tostring( ADRESPOSITIESnode ))
